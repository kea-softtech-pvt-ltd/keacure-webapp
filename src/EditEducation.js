...
function EditEducation(props){
    ...
    const removeImage =(EduId, index)=> {
        ...
        axios.post(`http://localhost:9000/api/deleteDocument/${EduId}`,{
    ...
    const fetchUpdateEducation = async () =>{
        const result = await axios.get(`http://localhost:9000/api/fetchEditEduData/${EduId}`); 
    ...
    async function EditData(e) {
        ...
        const res = await axios.post(`http://localhost:9000/api/updateEducation/${EduId}` , formData)
        .then(res =>{
