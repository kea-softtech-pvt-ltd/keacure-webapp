...
export default function RegisterDoctor(){
    ...
    const onSubmit = data => {
        ...
        axios.post(`http://localhost:9000/api/update/${doctorId}` , updateData)
                                ...
                                <div className="box_form">
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        ...
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div className="form-group">
                                                    <input type="text" className="form-control" onInput={handleChange} name="mobile" value={input.mobile} placeholder="Mobile Phone" {...register("mobile", { required: true ,maxLength: {
                                                value: 10 }})}/>
